...
public class GT_MetaTileEntity_Computer1 extends GT_MetaTileEntity_ComputerBase {
    ...
    public boolean checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack) {
       ...
       String name = getBaseMetaTileEntity().getBlockOffset(0,1,0).getUnlocalizedName();
       return getBaseMetaTileEntity().getBlockOffset(0,1,0).getUnlocalizedName().equals("tile.glass")&&getBaseMetaTileEntity().getBlockOffset(0,2,0).getUnlocalizedName().equals("tile.glass");
